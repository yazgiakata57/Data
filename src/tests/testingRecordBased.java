...
import main_structure.recordBased;
import main_structure.dataType;
import org.junit.Test;

import java.util.HashMap;
public class testingRecordBased {
    @Test
    public void testOne(){
        ...
        recordBased recordBasedDB= new recordBased();
        recordBasedDB.setCOLUMNS(columns);
        recordBasedDB.setRecordNum(3);
        recordBasedDB.setColumnNum(3);

        dataType[][] ret_val1=recordBasedDB.fieldToRecord(ret_val);
